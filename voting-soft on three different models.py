# -*- coding: utf-8 -*-
"""
Created on Mon Apr  9 08:49:40 2018
...
gbm_estimator = ensemble.GradientBoostingClassifier(random_state=100) #Model3
...
voting_grid = {'dt__max_depth':[3,5,7], 'rf__n_estimators':[20], 'rf__max_features':[5,6], 'rf__max_depth':[5], 'gbm__n_estimators':[10], 'gbm__max_depth':[4]}
...
titanic_test.to_csv('submission_soft_voting.csv', columns=['PassengerId','Survived'],index=False)