# -*- coding: utf-8 -*-
"""
Created on Tue Jun  5 01:29:58 2018

Code for titanic problem using decision tree, one-hot-encoding, parameter tuning, EDA and main focus is on Feature Importance
...
tree_estimator = tree.DecisionTreeClassifier(random_state=4876)
#Add parameters for tuning
#dt_grid = {'criterion':['gini','entropy'], 'max_depth':list(range(3,10)), 'min_samples_split':[2,3,6,7,8]}
dt_grid = {'criterion':['gini','entropy'], 'max_depth':list(range(8,9)), 'min_samples_split':[7,8]}
...
print(grid_tree_estimator.score(X_train, y_train)) #Train score  #Evalution of tree
...
titanic_test.to_csv('submission_EDA_with_feature_importance.csv', columns=['PassengerId','Survived'],index=False)